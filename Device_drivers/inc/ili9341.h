...
#define ILI9341_CSX_PIN	GPIO_PIN_NO_12

/*
*@ILI9341_DCX
*ILI9341 data/command input GPIO port & pin selection 
*/
#define ILI9341_DCX_PORT  GPIOB
#define ILI9341_DCX_PIN	GPIO_PIN_NO_11
...
#define ILI9341_RST_PIN	GPIO_PIN_NO_10
...
*@return 	None
*/
void ILI9341_draw_bitmap (uint16_t x, uint16_t y, uint8_t bitmap[], uint16_t w, uint16_t h, uint16_t color);
...
*@return 	None
*/
void ILI9341_draw_RGB_bitmap (uint16_t x, uint16_t y, uint16_t bitmap[], uint16_t w, uint16_t h);
